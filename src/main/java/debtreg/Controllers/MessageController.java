...
public class MessageController {
     ...
     public Message getDebt(@PathVariable Integer id) throws Exception {
     ...
     public ResponseEntity<Object> updateDebt(@RequestBody Message requestMessage, @PathVariable Integer id) throws Exception{
          Optional<Message> optionalDebt = repo.findById(id);
